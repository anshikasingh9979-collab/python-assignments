...
Emp1=Manager("Anshika",28,"emp5868",56000000,"CTO")
Emp2=Manager("Anushka",28,"emp5869",56000000,"ASTROLOGER")
Emp3=Manager("Riya",28,"emp5888",56000000,"DESIGN HEAD")
Emp4=Manager("Muranali",28,"emp5868","000000000000000000.1₹","CEO")
Emp1.display()
Emp2.display()
Emp3.display()
Emp4.display()
